...
[fname, pathname] = uigetfile('/home/murtaza/MRI Data/Data/Binned Files', ...
    'Select data file');   % data file (.mat)


%*************************************************
% folder path to save results
sfolder = ['/home/murtaza/MRI Data/Data/Recon Data/',saveName,'_',datestr8601,'/'];               
...
opt.lam2_core = 1e-1; %lagrange multiplier
