...
while ~stop
    ...
    A2xvar = A.multSq(xvar);                        % <---- GPU out of memory here
...
%         xvar = xvar;
%         rhat = rhat;
%         rvar = rvarOpt*scaleFac;   % report unscaled version
%         Axhat = Axhat;
%         shat = shatOpt/scaleFac;   % report unscaled version
%         svar = svarOpt/scaleFac;   % report unscaled version
        
        % Store variables for export
%         warning('removing stuff here')
%         phatFinal = [];
%         pvarFinal = [];
%         zhatFinal = [];
%         zvarFinal = [];
...
%         xvarFinal = [];
%         rhatFinal = [];
%         rvarFinal = [];   % report unscaled version
%         AxhatFinal = [];
%         shatFinal = [];   % report unscaled version
%         svarFinal = [];   % report unscaled version
