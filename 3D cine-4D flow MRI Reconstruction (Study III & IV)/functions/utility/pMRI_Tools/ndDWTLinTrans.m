classdef ndDWTLinTrans < LinTrans
...
methods
    % Constructor
    function obj = ndDWTLinTrans(w_prop,sizes,varargin)
        ...
        obj.W = nd_dwt_3D(w_prop.wname,sizes,'pres_l2_norm',obj.pres_l2_norm,'compute',obj.compute,'precision',obj.precision);
